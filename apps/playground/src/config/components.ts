...
export const COMPONENTS: ComponentEntry[] = [
  ...
  { id: "divider", label: "Divider", category: "Layout", description: "Visual separator between sections.", status: "ready" },
  { id: "paper", label: "Paper", category: "Layout", description: "Elevated surface container.", status: "ready" },
  { id: "app-shell", label: "AppShell", category: "Layout", description: "Application layout with sidebar, header, and main.", status: "ready" },
  { id: "topbar", label: "TopBar", category: "Layout", description: "Top application bar with title and actions.", status: "ready" },
  { id: "sidebar", label: "Sidebar", category: "Layout", description: "Side navigation panel.", status: "ready" },
  // Typography
  ...
  { id: "link", label: "Link", category: "Typography", description: "Styled anchor for navigation.", status: "ready" },
  // Actions
  ...
  { id: "combobox", label: "Combobox", category: "Forms", description: "Filterable select with search input.", status: "ready" },
  { id: "calendar", label: "Calendar", category: "Forms", description: "Month grid for date selection.", status: "ready" },
  { id: "date-picker", label: "DatePicker", category: "Forms", description: "Date input with calendar popup.", status: "ready" },
  ...
  { id: "slider", label: "Slider", category: "Forms", description: "Range input for numeric values.", status: "ready" },
  { id: "native-select", label: "NativeSelect", category: "Forms", description: "Deprecated native select fallback.", status: "basic" },
  // Feedback
  ...
  { id: "progress", label: "Progress", category: "Feedback", description: "Task completion indicator.", status: "ready" },
  ...
  { id: "alert-dialog", label: "AlertDialog", category: "Overlays", description: "Confirmation dialog for destructive actions.", status: "ready" },
  ...
  { id: "command-palette", label: "CommandPalette", category: "Overlays", description: "Searchable command launcher dialog.", status: "ready" },
  // Data display
  ...
  { id: "data-table", label: "DataTable", category: "Data display", description: "Table with sorting and global filter.", status: "ready" },
  { id: "timeline", label: "Timeline", category: "Data display", description: "Chronological list of events.", status: "ready" },
  // Navigation
  ...
  { id: "breadcrumbs", label: "Breadcrumbs", category: "Navigation", description: "Hierarchy navigation trail.", status: "ready" },
  { id: "pagination", label: "Pagination", category: "Navigation", description: "Page through numbered content.", status: "ready" },
  { id: "stepper", label: "Stepper", category: "Navigation", description: "Multi-step progress indicator.", status: "ready" }
];
